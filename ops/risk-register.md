...
| **R-13** | **Key person dependency.** In year 1 the founder is the brand, the sales team and the relationships. | 4 | 3 | **12** | Document the club list, the pitch and the process from day one. First rep hired month 7. Key person insurance before the growth round. |
...
| **R-15** | **Bear case materialises and we raise the growth round anyway.** The most expensive mistake available — R12m into a business that cannot service it. | 2 | 5 | **10** | Written decision gates at day 90 and month 14. If sell-through is below plan, hold headcount flat and run it as a profitable niche brand rather than raising. Say this to investors up front. |
